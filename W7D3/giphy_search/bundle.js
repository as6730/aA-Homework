...
var GiphysSearch = function (_Component) {
  ...
  function GiphysSearch(props) {
    ...
    (_this = _possibleConstructorReturn(this, (GiphysSearch.__proto__ || Object.getPrototypeOf(GiphysSearch)).call(this, props)), _this), _this.state = { searchTerm: "" };
    return _this;
  }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', {
          ...
          onChange: function onChange(event) {
            return _this2.setState({ searchTerm: event.target.value });
          } }),
        _react2.default.createElement(
          'button',
          { className: 'submit', onClick: this.props.fetchSearchGiphys },
          'Search'
        ),
        this.props.giphys.map(function (giphy, idx) {
          return _react2.default.createElement('img', { key: idx, src: giphy.bitly_gif_url });
        })
      );
    }
  }]);
...
var mapStateToProps = function mapStateToProps(state) {
  return {
    giphys: state.giphys === undefined ? [] : state.giphys
  };
};
...
exports.default = (0, _redux.combineReducers)({
  giphys: _giphys_reducer.giphysReducer
});
